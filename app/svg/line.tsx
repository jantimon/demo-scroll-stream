...
const lenghtSum = lengths.reduce((acc, length) => acc + length[0] + length[1], 0);

export const Arrow = ({order =  [0, 1, 2, 3, 4, 5, 6, 7, 8]} : {order?: number[]}) => {
    ...
    return <>
       <g transform="translate(19682.51 54020.34)">
        ...
        <g transform="translate(20011.67 53529.44)">
          ...
          <AnimateShellArrow mask="url(#shape_RLAcIO8U_83MTbG84D_ap_clip)">
            <path fill="transparent" d="M-100 -100H100V511.73H-100z"></path>
            <AnimatedLine
              $delay={delays[2]}
          ...
          <AnimatedLine
            ...
            strokeWidth="3.5"
            d="M5.25 402.64L0 411.73l-5.25-9.09"
          ></AnimatedLine></AnimateShellArrow>
        </g>
        ...
        <g transform="translate(19677.86 54065.07)">
          ...
          <AnimatedClientAction mask="url(#shape_ps4IGLnLtebdfzz2XypE__clip)">
        ...
        <g transform="translate(20002.48 54065.07)">
          ...
          <AnimatedClientAction mask="url(#shape_fACsxL4N5JmU-rfygu3aL_clip)">
            <path fill="transparent" d="M-100 -100H385.04V100H-100z"></path>
            <AnimatedLine
              $delay={delays[6]}
        ...
        <g transform="translate(20322.4 54065.07)">
          ...
          <AnimatedClientAction mask="url(#shape_aPSpMF39WoCB35bWtYMSX_clip)">
            <path fill="transparent" d="M-100 -100H385.04V100H-100z"></path>
            <AnimatedLine
              $delay={delays[7]}
          ...
          <AnimatedLine
            ...
            strokeWidth="3.5"
            d="M275.94-5.25l9.1 5.25-9.1 5.24"
          ></AnimatedLine></AnimatedClientAction>
        </g>
        <g transform="translate(20622.88 54065.07)">
          <defs>
            <mask id="shape_hegyohVZDOSbULy3VlKI6_clip">
              <path fill="#fff" d="M-85.256 -100H620.804V101.37H-85.256z"></path>
              <path fill="none" d="M511.7-5.225L520.81 0l-9.08 5.27"></path>
            </mask>
          </defs>
          <AnimatedDataTransfer mask="url(#shape_hegyohVZDOSbULy3VlKI6_clip)">
            <path fill="transparent" d="M-100 -100H606.06V101.37H-100z"></path>
            <AnimatedLine
              $delay={delays[8]}
...
const AnimatedLine = styled.path<{ $delay: number, $totalLength: number }>`
  ...
  animation-range: cover ${({$totalLength, $delay}) => $delay / lenghtSum * 100 / 4}% cover 
    ${({$totalLength, $delay}) => ($totalLength / lenghtSum + $delay / lenghtSum ) * 100 / 4}%;
`;
...
const AnimatedDataTransfer = styled.g`
  --x: -960px;
  --y: -1px;
  --y-step: 25px;
...
const AnimatedClientAction = styled.g`
  --x: 538px;
  --y: 1px;
...
const AnimatedLcpArrow = styled.g`
  --x: -608px;
  --y: 0px;
  animation: ${moveTransform} forwards;
  animation-timeline: scroll();
...
const AnimateShellArrow = styled.g`
  --x: 490px;
  --y: 1px;
  animation: ${moveTransform} forwards;
  animation-timeline: scroll();
